# 2024-02-26
# cp /Users/kimmyounghoon/Works/mkay/common/api-gateway/main/workers/CorePostProcessor.py ./api-gateway/main/workers/

# ./manage.py run_core_post_processor --baseapp=dosijy
...
class CorePostProcessor(object):

    def __init__(self, args={}):
        printer = RoPrinter(f'{args.baseapp} PostProcessor')
        self.rp = printer.rp
        self.ps = str_util.ProgressShower(gap=PRINT_GAP, info=f'{args.baseapp}PostProcessor')
        self.ps.printer = printer
        self.args = args

    def run(self):
        print(f'{self.args.baseapp}PostProcessor')
        self.make_index()
