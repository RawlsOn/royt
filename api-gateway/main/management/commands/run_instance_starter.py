...
class Command(BaseCommand):
    ...
    def handle(self, *args, **options):
        ...
        rp('InstanceStarter: Starting instance starter...')
        while True:
            try:
                worker.start_instances_where_region_not_finished()
            except Exception as e:
                rp(
                    'InstanceStarter: ' + str(e), msg_type='NOTICE'
                )
                raise e

            rp('InstanceStarter: Sleeping for 60 seconds...')
            time.sleep(60)